...
This comparison is based on public documentation and repository-visible behavior available at the time of review. If a project maintainer finds an incorrect entry, please open an issue or pull request.
...
- no runtime/player build footprint by default
