...
Two modes, both spawned as a separate OS process so tests exercise true
...
def build_state(last_processed_request_id: str) -> dict:
    return {
        "bridge_version": 1,
        "bridge_generation": 1,
        "bridge_session_id": "ipc-simulator-session",
        "transport": "file_ipc",
