...
Post-retro notes can be a section in the implementation design when the lesson
is small, or a separate dated retro file when the session exposed reusable
operator or lifecycle behavior.
