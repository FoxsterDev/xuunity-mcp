...
Last triage: 2026-09-08 (rebuilt-versus-cache-hit evidence implemented in current source)
...
- Current source closes that gap with Unity's assembly-started and
