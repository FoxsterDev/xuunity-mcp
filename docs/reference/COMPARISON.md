...
| Area | Status | Caveat |
| --- | --- | --- |
| Current package source | `Git UPM available` | Source package is `v0.3.77` at `packages/com.xuunity.light-mcp`; `v0.3.77` is the current Git UPM release target. OpenUPM publication is still pending. |
