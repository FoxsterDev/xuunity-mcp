...
- `../operations/DEVMODE_VALIDATION.md`
...
- `../archive/retros/2026-05-11_operator_and_backend_lessons.md`
...
- `../operations/BUILD_AUTOMATION.md` for lane selection and build-policy rules
- `COMPARISON.md` for backend selection rules
- `../archive/retros/2026-05-11_operator_and_backend_lessons.md` for distilled operator lessons
...
- `../../scripts/testing/run_multi_project_gui_test_subset.sh`
- `../../scripts/testing/run_unity_version_matrix.sh`
- `xuunity_light_unity_mcp.sh`
- `../../scripts/tools/arrange_unity_windows.py`
- `../operations/SMOKE_TESTS.md`
- `templates/run.sh`
- `templates/server.py`
- `templates/scenarios/`
...
```bash
bash AIRoot/Operations/XUUnityLightUnityMcp/scripts/testing/run_unity_version_matrix.sh
```
...
```bash
bash AIRoot/Operations/XUUnityLightUnityMcp/scripts/testing/run_unity_version_matrix.sh --list-detected
```
...
```bash
AIRoot/Operations/XUUnityLightUnityMcp/scripts/testing/run_multi_project_gui_test_subset.sh \
  --repo-root /path/to/repo-with-unity-projects \
  --parallelism 3
```
...
1. run `../../scripts/testing/run_multi_project_batch_compile_matrix.sh`
...
- after executable-code changes to this MCP host/server/package, use
  `../operations/DEVMODE_VALIDATION.md` as the source-of-truth closeout rule; project-specific
...
See `../operations/SMOKE_TESTS.md` for the public reusable MCP smoke baseline.
...
agent-agnostic and documented in `../agents/AI_INTEGRATION.md`.
