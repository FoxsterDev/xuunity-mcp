...
| --- | --- | --- |
| Current package path | `Validated` | Production Git UPM path is `packages/com.xuunity.light-mcp#v0.3.45`; old `templates/unity-package#v0.3.11` is migration-only. |
