...
- standalone public repository and current `v0.3.79` Git UPM package path under
...
- production Git UPM consumption through `v0.3.79`
...
- `v0.3.12` moved the package to the registry-native path and `v0.3.79` is the
