...
SOURCE_ROOT="${XUUNITY_LIGHT_UNITY_MCP_SOURCE_ROOT:-$SCRIPT_DIR}"
WRAPPER_PATH="${XUUNITY_LIGHT_UNITY_MCP_WRAPPER:-$SCRIPT_DIR/xuunity_light_unity_mcp.sh}"
ARRANGE_SCRIPT_PATH="${XUUNITY_LIGHT_UNITY_MCP_ARRANGE_SCRIPT:-$SOURCE_ROOT/arrange_unity_windows.py}"
